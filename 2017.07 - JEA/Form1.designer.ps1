...
$label2.Location = New-Object -TypeName System.Drawing.Point -ArgumentList @(223,78)
$label2.Name = 'label2'
...
$label3.Location = New-Object -TypeName System.Drawing.Point -ArgumentList @(220,143)
$label3.Name = 'label3'
